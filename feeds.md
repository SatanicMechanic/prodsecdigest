...
- **OWASP** — removed 2026-09-13. Their site redesign dropped RSS entirely (`/feed` and `/feed.xml` both 404; no `rel="alternate"` feed link anywhere on owasp.org). Re-add if they bring a feed back.
